...
////////////////////				////////////////////				////////////////////
	...
	function process_form(){
		...
		if(mysqli_query($db, $sql)){
			...
			<img src='../cb26_Docs/temp/".$_POST['myimg']."' height='120px' width='90px' />
					</td>
				</tr>
				<tr>
			...
			$filename = "../cb26_Docs/img_proveedores/".$_POST['myimg'];							
			$tempfilename = "../cb26_Docs/temp/".$_POST['myimg'];							
			copy($filename, $tempfilename);

			$destination_file = "../cb26_Docs/img_proveedores/".$_POST['myimg'];

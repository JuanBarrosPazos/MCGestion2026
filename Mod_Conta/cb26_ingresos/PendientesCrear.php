...
////////////////////				////////////////////				////////////////////
	...
	function process_form(){
		...
		if(mysqli_query($db, $sqla)){ 
			...
			if($_FILES['myimg1']['size'] == 0){ 
				$new_name1 = $_POST['factnum']."_1.png";
				$rename_filename1 = "../cb26_Docs/docingresos_pendientes/".$new_name1;								
				copy("../cb26_Docs/docingresos_pendientes/untitled.png", $rename_filename1);
			}else{
				...
				$destination_file1 = "../cb26_Docs/docingresos_pendientes/".$safe_filename1;
			
			if( file_exists("../cb26_Docs/docingresos_pendientes/".$nombre1) ){
					unlink("../cb26_Docs/docingresos_pendientes/".$nombre1);
			...
			if($_FILES['myimg2']['size'] == 0){
					$new_name2 = $_POST['factnum']."_2.png";
					$rename_filename2 = "../cb26_Docs/docingresos_pendientes/".$new_name2;								
					copy("../cb26_Docs/docingresos_pendientes/untitled.png", $rename_filename2);
			}else{
				...
				$destination_file2 = "../cb26_Docs/docingresos_pendientes/".$safe_filename2;
			
				if( file_exists("../cb26_Docs/docingresos_pendientes/".$nombre2) ){
						unlink("../cb26_Docs/docingresos_pendientes/".$nombre2);
					//	print("** El archivo ".$nombre1." Ya existe, seleccione otra imagen.</br>");
			...
			if($_FILES['myimg3']['size'] == 0){
					$new_name3 = $_POST['factnum']."_3.png";
					$rename_filename3 = "../cb26_Docs/docingresos_pendientes/".$new_name3;								
					copy("../cb26_Docs/docingresos_pendientes/untitled.png", $rename_filename3);
			}else{
				...
				$destination_file3 = "../cb26_Docs/docingresos_pendientes/".$safe_filename3;
			
				if( file_exists("../cb26_Docs/docingresos_pendientes/".$nombre3) ){
						unlink("../cb26_Docs/docingresos_pendientes/".$nombre3);
					//	print("** El archivo ".$nombre1." Ya existe, seleccione otra imagen.</br>");
			...
			if($_FILES['myimg4']['size'] == 0){
					$new_name4 = $_POST['factnum']."_4.png";
					$rename_filename4 = "../cb26_Docs/docingresos_pendientes/".$new_name4;								
					copy("../cb26_Docs/docingresos_pendientes/untitled.png", $rename_filename4);
			}else{
				...
				$destination_file4 = "../cb26_Docs/docingresos_pendientes/".$safe_filename4;
			
				if( file_exists("../cb26_Docs/docingresos_pendientes/".$nombre4) ){
						unlink("../cb26_Docs/docingresos_pendientes/".$nombre4);
					//	print("** El archivo ".$nombre1." Ya existe, seleccione otra imagen.</br>");
